...
{
    public class CELLINFORMATIONDOWNLOAD1
    {
        public CELLINFORMATIONDOWNLOAD1(PLCHelper plcdata, BODYCellInfor cell)
        {
            ...
            try
            {
                ...
                word.FirstOrDefault(x => x.Item == "CELLINFORESULT").SetValue = cell.CELLINFORESULT;
    ...
    public class CELLINFORMATIONDOWNLOAD2
    {
        public CELLINFORMATIONDOWNLOAD2(PLCHelper plcdata, BODYCellInfor cell)
        {
