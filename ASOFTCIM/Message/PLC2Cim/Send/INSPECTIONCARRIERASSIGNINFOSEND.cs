...
{
    public class INSPECTIONCARRIERASSIGNINFOSEND1
    {
        public INSPECTIONCARRIERASSIGNINFOSEND1(PLCHelper plcdata, CARRIERINFODOWNLOAD carrier)
        {
    ...
    public class INSPECTIONCARRIERASSIGNINFOSEND2
    {
        public INSPECTIONCARRIERASSIGNINFOSEND2(PLCHelper plcdata, CARRIERINFODOWNLOAD carrier)
        {
