...
{
    public class INSPECTIONCARRIERRELEASEINFOSEND1
    {
        public INSPECTIONCARRIERRELEASEINFOSEND1(PLCHelper plcdata, CARRIERINFODOWNLOAD carrier)
        {
    ...
    public class INSPECTIONCARRIERRELEASEINFOSEND2
    {
        public INSPECTIONCARRIERRELEASEINFOSEND2(PLCHelper plcdata, CARRIERINFODOWNLOAD carrier)
        {
