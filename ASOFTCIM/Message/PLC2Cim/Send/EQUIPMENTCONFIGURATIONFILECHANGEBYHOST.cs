...
{
    public class EQUIPMENTCONFIGURATIONFILECHANGEBYHOST1
    {
        public EQUIPMENTCONFIGURATIONFILECHANGEBYHOST1(PLCHelper plcdata, ConfigFileChange config)
        {
    ...
    public class EQUIPMENTCONFIGURATIONFILECHANGEBYHOST2
    {
        public EQUIPMENTCONFIGURATIONFILECHANGEBYHOST2(PLCHelper plcdata, ConfigFileChange config)
        {
